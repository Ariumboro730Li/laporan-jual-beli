...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2018 at 09:48 PM
-- Server version: 5.6.16-MariaDB
-- PHP Version: 5.5.9
...
CREATE TABLE `data_barang` (
  ...
  `harga_beli_semua` varchar(200) NOT NULL,
  `harga_beli` varchar(200) NOT NULL,
  `harga_pokok` varchar(200) NOT NULL,
  `harga_jual` varchar(200) NOT NULL,
  `laba_barang` varchar(200) NOT NULL,
  `laba_barang_semua` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `user_akses` enum('gratis','premium','admin') NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `pelanggan` (
  ...
  `kartu_identitas` varchar(200) NOT NULL,
  `nama_pelanggan` varchar(200) NOT NULL,
  `barang_favorit` varchar(200) NOT NULL,
  `no_handphone` varchar(200) NOT NULL,
  `ultah` varchar(200) NOT NULL,
  `status` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `pembelian` (
  ...
  `lo` varchar(40) NOT NULL,
  `pres` varchar(40) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `penjualan` (
  ...
  `total_penjualan` varchar(200) NOT NULL,
  `keuntungan` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
